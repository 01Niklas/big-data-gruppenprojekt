...
if __name__ == '__main__':
    ...
    tests = [
        Test(name="UserBased_1_cosine", type="collaborative_filtering", mode="user", k_value=2, metric="cosine", calculation_variety="weighted"),
        ...
        Test(name="UserBased_4_cosine", type="collaborative_filtering", mode="user", k_value=5, metric="cosine", calculation_variety="weighted"), # --> best in our tests (for only content based) based on the test data

        Test(name="ItemBased_1_cosine", type="collaborative_filtering", mode="item", k_value=2, metric="cosine", calculation_variety="weighted"),
        ...
        Test(name="UserBased_1_pearson", type="collaborative_filtering", mode="user", k_value=2, metric="pearson", calculation_variety="weighted"),
        ...
        Test(name="UserBased_4_pearson", type="collaborative_filtering", mode="user", k_value=5, metric="pearson", calculation_variety="weighted"), # --> best in our tests (for only content based) based on the test data

        Test(name="ItemBased_1_pearson", type="collaborative_filtering", mode="item", k_value=2, metric="pearson", calculation_variety="weighted"),
        ...
        Test(name="ContentBased_12", type="content_based", k_value=14), # --> best in our tests (for only content based) based on the test data
        ...
        Test(name="Hybrid_4", type="hybrid", mode="user", k_value=5, second_k_value=14, metric="cosine", calculation_variety="weighted", alpha=0.5), # --> best in our tests (for only content based) based on the test data
        ...
        Test(name="Hybrid_10", type="hybrid", mode="user", k_value=5, second_k_value=14, metric="pearson", calculation_variety="weighted", alpha=0.5), # --> best in our tests (for only content based) based on the test data
