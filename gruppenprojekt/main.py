...
tests = [
    ...
    # Test(name="UserBased_4", type="collaborative_filtering", mode="user", k_value=5, metric="cosine", calculation_variety="weighted"), # --> best in our tests (for only content based) based on the test data
